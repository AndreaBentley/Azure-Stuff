...
import com.example.AzureBlobDemo.PrintHelper;
...
/**
  ...
  */
public class GiveBlocksAnAdvancedShot {
    ...
    /**
      ...
      */
    public void runSamples() throws InvalidKeyException, URISyntaxException, IOException {
        System.out.println();
        System.out.println();
...
//            System.out.println();
    ...
    /**
      * Manage the service properties for the given storage service, which include Logging, HourMetrics,
      * MinuteMetrics and CORS configuration.
      * @param blobClient Azure Storage Blob Service
      */
